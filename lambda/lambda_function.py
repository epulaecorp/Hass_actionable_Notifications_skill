...
HOME_ASSISTANT_URL                = 'https://hass.iothome.space'       # REPLACE WITH THE URL FOR YOUR HA FRONTEND
VERIFY_SSL                        = True                              # SET TO FALSE IF YOU DO NOT HAVE VALID CERTS
TOKEN                             = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJkMWIzNTQ3NjBiOWE0M2RkOTIzNTMzY2ExNDMzMmM3NyIsImlhdCI6MTY5Njk5MjQ0MywiZXhwIjoyMDEyMzUyNDQzfQ.7XKPr3dxEQ2_NtrnrOXoffopZqEIae4vAU4fQ5Y8BUM'                                # ADD YOUR LONG LIVED TOKEN IF NEEDED OTHERWISE LEAVE BLANK
